...
<div class="container-fluid text-center">
    <div class="row">
        ...
        <div class="col-sm-10 content">
            ...
            <form:form  id="groupRegisterForm" class="form-inline" method="post" modelAttribute="group" action="saveGroup" name="frmAddGroup">

                <div class="form-group">
                	<form:hidden path="id" value="${group.id}"/>
                    <form:input type="text" class="form-control" path="groupNumber" maxlength="10" name="groupNumber" id="groupNumber" placeholder="Номер группы"
                    value="${group.groupNumber}"/>
                </div>
                <div class="form-group">
                    <input class="form-control" class="btn btn-default" type="submit"  name="addGroup" id="send" value="Добавить" >
                </div>
            </form:form>
