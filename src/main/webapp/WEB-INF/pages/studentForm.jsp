...
<div class="container-fluid text-center">
    <div class="row">
        ...
        <div class="col-sm-10 content">
            ...
            <form:form  id="studentRegisterForm" class="form-inline" method="post" modelAttribute="student" action="saveStudent" name="frmAddStudent">

                <div class="form-group">
                 	<form:hidden path="id" value="${student.id}"/>
                    <form:input type="text" class="form-control" path="firstName" maxlength="50" placeholder="Имя" value="${student.firstName}"/>
                </div>
                <div class="form-group">
                    <form:input type="text" class="form-control" path="lastName" maxlength="50" name="lastName" id="lastName" placeholder="Фамилия" value="${student.lastName}"/>
                </div>
                <div class="form-group">
				...
				<div class="form-group">
                    <input class="form-control" class="btn btn-default" type="submit"  name="saveStudent" id="send" value="Добавить" >
                </div>
            </form:form>
