    ...
    <div class="row">
        ...
        <div class="col-sm-10 content">
         ...
         <!--   <h4 class="text-center">Поиск студента по ID</h4>
             <form  id="jform" class="form-inline" method="post" action="group?action=find" >
                <div class="form-group">
                    <input type="text" class="form-control" maxlength="17" name="id" id="id" placeholder="ID студента">
                </div>
                <div class="form-group">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th style="vertical-align: middle"><h6 class="text-center">${s.group.groupNumber}</h6></th>
                              	<td style="vertical-align: middle"><h6 class="text-center"><a href="deleteStudent?id=<c:out value="${s.id}"/>">Удалить</a></h6></td>
                              	<td style="vertical-align: middle"><h6 class="text-center"><a href="editStudent?id=<c:out value="${s.id}"/>">Изменить</a></h6></td>
